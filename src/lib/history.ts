...
// Scheme Eligibility & Recommendation session.
export type EligibilityHistoryItem = BaseHistoryItem & {
    type: 'eligibility';
    profile: CitizenProfile;
    results: SchemeEligibilityResult[] | null;
};

// PDF -> Knowledge Graph generation session.
export type GraphHistoryItem = BaseHistoryItem & {
    type: 'graph';
    document: Document;
